...
export const ERROR_MESSAGES_FA: Record<string, string> = {
  ...
  TELEGRAM_AUTH_FAILED: 'تأیید هویت تلگرام انجام نشد. مینی‌اپ را ببند و دوباره از داخل ربات بازش کن.',
  TELEGRAM_AUTH_EXPIRED: 'نشست تلگرام منقضی شده. مینی‌اپ را ببند و دوباره از داخل ربات بازش کن.',
  TELEGRAM_AUTH_REQUIRED: 'برای بازی باید مینی‌اپ را از داخل تلگرام باز کنی.',
  ALREADY_DISCARDED: 'قبلاً کارت‌هایت را سوزانده‌ای.',
  ...
  REDEAL_DISABLED: 'قانون ده‌لو کم برای این میز فعال نیست.',
  REDEAL_LIMIT: 'دیگر نمی‌توانی درخواست پخش دوباره بدهی.',
  REDEAL_NOT_ALLOWED: 'دست تو به اندازه کافی ضعیف نیست؛ ده‌لو کم نمی‌شود.',
  ...
  ROOM_EMPTY: 'صندلی خالی برای افزودن ربات وجود ندارد.',
  BOT_NOT_FOUND: 'این ربات در میز پیدا نشد.',
  CANNOT_REMOVE_HUMAN: 'فقط ربات‌ها را می‌توان از میز حذف کرد.',
