...
**تست‌ها: ۷۶۶ تست، همه سبز** — game-engine ۱۲۲ · api ۲۳۲ · web ۴۱۲
...
مرحله‌ی بعدی **۴.۵ — ادغام با تلگرام** است: haptic feedback، هماهنگی رنگ هدر،
`viewportStableHeight`. همه با fallback امن (نبود SDK نباید خطا بدهد).
